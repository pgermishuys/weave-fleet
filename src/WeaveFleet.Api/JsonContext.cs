...
[JsonSerializable(typeof(IReadOnlyList<WeaveFleet.Application.Workflows.WorkflowRunDto>))]
...
[JsonSerializable(typeof(WeaveFleet.Application.Workflows.CheckWorkflowRequest))]
[JsonSerializable(typeof(WeaveFleet.Application.Workflows.WorkflowCheckDto))]
[JsonSerializable(typeof(WeaveFleet.Application.Workflows.OpenWorkflowFileRequest))]
[JsonSerializable(typeof(WeaveFleet.Application.Workflows.SaveWorkflowFileRequest))]
[JsonSerializable(typeof(WeaveFleet.Application.Workflows.CreateWorkflowRequest))]
[JsonSerializable(typeof(WeaveFleet.Application.Workflows.WorkflowFileDto))]
[JsonSerializable(typeof(WeaveFleet.Application.Workflows.DraftWorkflowFromSessionRequest))]
[JsonSerializable(typeof(WeaveFleet.Application.Workflows.DraftWorkflowFromDescriptionRequest))]
...
[JsonSerializable(typeof(AppStartRequest))]
[JsonSerializable(typeof(AppPreviewResponse))]
[JsonSerializable(typeof(BrowserOpenRequest))]
[JsonSerializable(typeof(BrowserOpenResponse))]
// Session Sources
...
[JsonSerializable(typeof(RunShellCommandApiRequest))]
...
[JsonSerializable(typeof(GitHubItemPage))]
[JsonSerializable(typeof(GitHubItemSummary))]
[JsonSerializable(typeof(GitHubItemSummary[]))]
[JsonSerializable(typeof(IReadOnlyList<GitHubItemSummary>))]
[JsonSerializable(typeof(GitHubItemDetail))]
[JsonSerializable(typeof(GitHubWorkResponse))]
[JsonSerializable(typeof(GitHubLabelDto))]
[JsonSerializable(typeof(GitHubReviewerDto))]
[JsonSerializable(typeof(GitHubCheckDto))]
[JsonSerializable(typeof(GitHubTimelineEntry))]
[JsonSerializable(typeof(GitHubReferenceDto))]
[JsonSerializable(typeof(GitHubRepoCounts))]
// Automations
...
[JsonSerializable(typeof(List<WeaveFleet.Application.Services.HarnessProfileView>))]
[JsonSerializable(typeof(WeaveFleet.Application.Harnesses.HarnessProfileCheck))]
...
[JsonSerializable(typeof(WeaveFleet.Application.Harnesses.HarnessSignInAttemptStatus))]
[JsonSerializable(typeof(WeaveFleet.Api.Endpoints.SignInWithKeyRequest))]
[JsonSerializable(typeof(WeaveFleet.Api.Endpoints.StartSignInRequest))]
[JsonSerializable(typeof(WeaveFleet.Api.Endpoints.SignInCodeRequest))]
[JsonSerializable(typeof(WeaveFleet.Api.Endpoints.SignInCallbackRequest))]
