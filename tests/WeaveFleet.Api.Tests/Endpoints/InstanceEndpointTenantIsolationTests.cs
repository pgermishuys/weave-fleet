...
#pragma warning restore CA1001
{
        ...
        IReadOnlyList<ProviderInfo> providers) : IHarnessSession
    {
        ...
        public Task<string?> SendCommandAsync(CommandOptions options, CancellationToken ct) => Task.FromResult(options.MessageId);
        ...
        public Task<string?> AskOffTheRecordAsync(string prompt, CancellationToken ct) => Task.FromResult<string?>(null);
