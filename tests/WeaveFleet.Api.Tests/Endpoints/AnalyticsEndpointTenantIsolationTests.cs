...
#pragma warning restore CA1001
{
    ...
    private sealed class AnalyticsWebApplicationFactory : WebApplicationFactory<Program>
    {
        private readonly string _dbPath =
            Path.Combine(Path.GetTempPath(), $"weave-fleet-analytics-isolation-{Guid.NewGuid():N}.db");
        private readonly string _analyticsDbPath =
            Path.Combine(Path.GetTempPath(), $"weave-fleet-analytics-isolation-analytics-{Guid.NewGuid():N}.db");
