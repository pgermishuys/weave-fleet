...
public sealed class JsonSerializationContextTests
{
    ...
    public void Session_progress_serializes_from_the_source_generated_context()
    {
        ...
        Assert.Equal(
            """{"sessionId":"s1","kind":"todos","done":1,"total":2,"current":"Drop the indexes","todos":[{"content":"Drop the indexes","status":"in_progress","priority":null}],"updatedAt":"2026-09-13T12:24:00.0000000Z","plan":null,"subagents":[]}""",
            json);
