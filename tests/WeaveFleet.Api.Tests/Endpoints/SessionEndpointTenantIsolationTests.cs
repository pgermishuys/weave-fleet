...
#pragma warning restore CA1001
{
        ...
        FakeHarnessSession inner) : IHarnessSession
    {
        ...
        public Task<string?> AskOffTheRecordAsync(string prompt, CancellationToken ct) => inner.AskOffTheRecordAsync(prompt, ct);
        public Task<string?> GetActivityStatusAsync(CancellationToken ct) => inner.GetActivityStatusAsync(ct);
